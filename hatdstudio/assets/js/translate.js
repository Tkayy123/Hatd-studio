...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    'Commercial & Shop Fit Out':    'Thương Mại & Cửa Hàng',
    ...
    'Home extensions, renovations, and period restorations':
      'Mở rộng, cải tạo nhà và phục hồi công trình di sản',
    ...
    '"The renovation of our period home was a complex project, but HATD Studio handled everything with professionalism and care. They respected the original character while introducing modern functionality. The result is stunning."':
      '"Việc cải tạo ngôi nhà di sản của chúng tôi là một dự án phức tạp, nhưng HATD Studio đã xử lý mọi thứ chuyên nghiệp và tận tâm. Họ tôn trọng kiến trúc gốc trong khi đưa vào chức năng hiện đại. Kết quả thật tuyệt vời."',
    ...
    'As specialised residential building designers, we bring together technical expertise and creative vision to deliver homes that are as beautiful as they are functional. From classic restorations to contemporary new builds, every project is shaped by your way of life.':
      'Là những nhà thiết kế công trình nhà ở chuyên nghiệp, chúng tôi kết hợp chuyên môn kỹ thuật và tầm nhìn sáng tạo để tạo ra những ngôi nhà vừa đẹp vừa tiện dụng. Từ cải tạo di sản đến xây mới hiện đại, mọi dự án đều được định hình theo lối sống của bạn.',
    ...
    'Extensions & Renovations':             'Mở Rộng & Cải Tạo',
    'Home extensions, renovations, and period restorations':
      'Mở rộng nhà, cải tạo và phục hồi công trình di sản',
    'We believe in the power of transformation. Whether you\'re extending your family home, renovating a tired space, or restoring a period property, our team brings the same precision and care to every project — respecting what exists while introducing new possibilities.':
      'Chúng tôi tin vào sức mạnh của sự chuyển đổi. Dù bạn đang mở rộng ngôi nhà gia đình, cải tạo không gian cũ kỹ hay phục hồi công trình di sản, đội ngũ của chúng tôi mang đến sự chính xác và tỉ mỉ như nhau cho mọi dự án — tôn trọng những gì đã có trong khi giới thiệu những khả năng mới.',
  ...
  console.log('🌐 HATD static translation system ready');
