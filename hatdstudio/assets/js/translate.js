...
(function () {
  ...
  var TRANSLATIONS_BY_KEY = {
    'sub-quote': {
      en: 'Specialising in residential design that adapts to your way of life —<br>from classic restorations to contemporary new builds.',
      vi: 'Chuyên thiết kế nhà ở phù hợp với lối sống của bạn —<br>từ cải tạo nhà cổ điển đến xây mới hiện đại.'
    },
